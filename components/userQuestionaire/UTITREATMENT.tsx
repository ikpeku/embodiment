        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            <KeyboardAvoidingView >
                ...
                {+progress.toFixed(1) * 10 === 1 && <View style={{ marginVertical: 15, gap: 15 }}>
                    ...
                    <CustomButton title={sex === "Female" ? "Next" : "Submit"} onPress={handleStepOne} />
                ...
                {+progress.toFixed(1) * 10 === 2 && <View style={{ marginVertical: 15, gap: 15 }}>
                    ...
                    <CustomButton title={condition === "None" ? "Next" : "Submit"} onPress={handleStepTwo} />
                ...
                {+progress.toFixed(1) * 10 === 5 && <View style={{ marginVertical: 15, gap: 15 }}>
                    ...
                    <CustomButton type={question5 ? "primary" : "disable"} title={"Next"} onPress={() => setProgress((current) => current + 0.1)} />
                ...
                {+progress.toFixed(1) * 10 === 6 && <View style={{ marginVertical: 15, gap: 15 }}>
                    ...
                    <CustomButton title={question6 === "No" ? "Submit" : "Next"} onPress={handleStepSix} />
                ...
                {+progress.toFixed(1) * 10 === 7 && <View style={{ marginVertical: 15, gap: 15 }}>
                    ...
                    <CustomButton title={question7 === "No" ? "Submit" : "Next"} onPress={handleStepSeven} />
                ...
                {+progress.toFixed(1) * 10 === 11 && <View style={{ marginVertical: 15, gap: 15 }}>
                    ...
                    <CustomButton title={"Submit"} onPress={handleStepElleven} />
